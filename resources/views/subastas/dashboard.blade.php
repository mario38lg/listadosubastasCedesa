...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;700&family=Syne:wght@700;800&display=swap" rel="stylesheet">
        <link rel="stylesheet" href="{{ asset('css/views/subastas-dashboard.css') }}?v=13">
</head>
<body>
    @php
        ...
        $importCreado = request('import_created') === '1' || session('import_created') === '1';
    @endphp
    <div class="wrap">
        <div class="top">
        ...
        @if ($importCreado)
            <div class="import-success-message" role="status" aria-live="polite">Se creó correctamente la subasta.</div>
        @endif
