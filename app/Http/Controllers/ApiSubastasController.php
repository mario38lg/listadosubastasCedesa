...
class ApiSubastasController extends Controller
{
    ...
    public function storeFromScraperApi(Request $request): JsonResponse
    {
        ...
        $datosRecibidos = $request->validate([
            ...
            'cantidad_reclamada' => ['nullable', 'string', 'max:255'],
            'lotes' => ['nullable', 'string', 'max:255'],
            'valor_subasta' => ['nullable', 'string', 'max:255'],
            'valor_tasacion' => ['nullable', 'string', 'max:255'],
            'tasacion' => ['nullable', 'string', 'max:255'],
            'puja_minima' => ['nullable', 'string', 'max:255'],
            'tramos_entre_pujas' => ['nullable', 'string', 'max:255'],
            'importe_deposito' => ['nullable', 'string', 'max:255'],
